...
(defvar *my-application-keymap*
  (let ((m (make-sparse-keymap)))
    ...
    (define-key m (stumpwm:kbd "e") "exec emacsclient -c")
    (define-key m (stumpwm:kbd "E") "exec emacs")
    (define-key m (stumpwm:kbd "[") "exec kitty -e \"emacsclient -t\"")
    (define-key m (stumpwm:kbd "w") "exec icecat")
    (define-key m (stumpwm:kbd "b") "exec pcmanfm")
    (stumpwm:define-key stumpwm:*root-map* (stumpwm:kbd "w") "exec icecat")
    (stumpwm:define-key stumpwm:*root-map* (stumpwm:kbd "m") "exec icedove")
    (define-key m (stumpwm:kbd "t") "exec kitty")
    (stumpwm:define-key stumpwm:*root-map* (stumpwm:kbd "b") "exec pcmanfm")
    (define-key m (stumpwm:kbd "a") "exec pavucontrol")
    (define-key m (stumpwm:kbd "b") "exec bluedevil-wizard")
    (define-key m (stumpwm:kbd "/") "exec rofi -combi-modi drun,window -show combi")
